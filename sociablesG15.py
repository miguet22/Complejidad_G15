        ...
        if sumatoria not in c_primos:
            ...
            if not ciclo_invalido:
                ...
                if secuencia[0] == secuencia[rango] and  ( (len (conjunto)) == rango):
                    salida.append (secuencia [0:rango])
...
mostrar = sociables (n,rangee)

print (f"Conjuntos sociables del orden: {rangee}")
for i in range (0,len (mostrar)):
    print (mostrar [i])
